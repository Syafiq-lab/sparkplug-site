...
const CopyBlock = () => (
    <div className="max-w-3xl mx-auto text-center space-y-8 font-serif">
        <img src="/assets/logo-1.svg " alt="5parkplug"
        ...
        <div className="w-full max-w-sm sm:max-w-2xl md:max-w-3xl lg:max-w-4xl xl:max-w-5xl 2xl:max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12">
                <div className="space-y-4">
                    <p className="text-base md:text-lg text-neutral-300 leading-relaxed text-left wefont-serif">
                        Hello there. Welcome.
                        <br/>
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-base md:text-lg text-neutral-300 leading-relaxed text-left wefont-serif">
                        Follow us at <a href="https://www.instagram.com/5parkplug.turns.you.on/" target="_blank" rel="noopener noreferrer" className="font-bold text-white">5parkplug.turns.you.on</a> for
                    ...
                    <p className="text-base md:text-lg text-neutral-300 leading-relaxed text-left wefont-serif" style={{ marginTop: '2rem' }}>
                        Warmest regards,</p>

                    <div className="relative flex items-left">
                        <img src="/assets/star.svg" alt="" className="w-40 h-auto opacity-95"/>
                    </div>
                </div>
            </div>
        </div>
...
export default function App() {
    return (
        <main
            className="min-h-screen text-neutral-300 bg-radial-mask flex items-center justify-center px-6 py-20 relative overflow-hidden font-serif">
